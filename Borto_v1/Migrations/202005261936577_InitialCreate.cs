namespace Borto_v1.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        UserId = c.Int(nullable: false),
                        UserSubId = c.Int(nullable: false),
                        UserSub_IdUser = c.Int(),
                        User_IdUser = c.Int(),
                    })
                .PrimaryKey(t => t.SubscriptionId)
                .ForeignKey("dbo.Users", t => t.UserId, cascadeDelete: true)
                .ForeignKey("dbo.Users", t => t.UserSub_IdUser)
                .ForeignKey("dbo.Users", t => t.User_IdUser)
                .Index(t => t.UserId)
                .Index(t => t.UserSub_IdUser)
        ...
        {
            DropForeignKey("dbo.Subscriptions", "User_IdUser", "dbo.Users");
            DropForeignKey("dbo.Subscriptions", "UserSub_IdUser", "dbo.Users");
            ...
            DropIndex("dbo.Subscriptions", new[] { "User_IdUser" });
            DropIndex("dbo.Subscriptions", new[] { "UserSub_IdUser" });
